...
- Формат — мини-группа до трёх учеников, каждый со своим компьютером: Zoom и
  VS Code; каждый пишет сам, преподаватель ведёт и подсказывает.
...
- Если техника подвела — ученик смотрит разбор и навёрстывает дома по
  шпаргалке; это запасной режим, не норма.
...
| `CS` | Компьютер изнутри | как это всё устроено под капотом | впереди |
...
PR извне не ожидаются — курс ведётся в мини-группе и меняется под конкретных
учеников, но методику и инструменты можно свободно переиспользовать:
